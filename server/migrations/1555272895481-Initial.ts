...
export class Initial1555272895481 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "spot" ("id" SERIAL NOT NULL, "surface" "spot_surface_enum" NOT NULL DEFAULT 'unknown', "islandName" character varying, "coordsX" integer NOT NULL, "coordsY" integer NOT NULL, CONSTRAINT "PK_f2a0a47e5ae78713daf83a5f7b0" PRIMARY KEY ("id"))`)
        await queryRunner.query(`CREATE TABLE "island" ("name" character varying NOT NULL, "geography" jsonb NOT NULL DEFAULT '{"hexalots":"","spots":""}', CONSTRAINT "PK_d2e09632410dca340e1232d8899" PRIMARY KEY ("name"))`)
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`)
        await queryRunner.query(`CREATE TABLE "hexalot" ("id" character varying(32) NOT NULL, "nonce" integer NOT NULL, "genomeData" jsonb, "journey" jsonb, "islandName" character varying, "centerSpotId" integer, "ownerId" integer, "parentId" character varying(32), CONSTRAINT "REL_29aea8e61e03cb080eb29670bf" UNIQUE ("centerSpotId"), CONSTRAINT "PK_0ac1613009c8e7f41143a632032" PRIMARY KEY ("id"))`)
        ...
        await queryRunner.query(`ALTER TABLE "hexalot" ADD CONSTRAINT "FK_29aea8e61e03cb080eb29670bf4" FOREIGN KEY ("centerSpotId") REFERENCES "spot"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "hexalot" DROP CONSTRAINT "FK_29aea8e61e03cb080eb29670bf4"`)
