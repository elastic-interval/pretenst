...
export class Initial1555272895481 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "hexalot" ("id" character varying(32) NOT NULL, "nonce" integer NOT NULL, "genomeData" jsonb NOT NULL, "journey" jsonb NOT NULL, "parentId" character varying(32), "ownerId" integer, "islandName" character varying, "centerX" integer NOT NULL, "centerY" integer NOT NULL, CONSTRAINT "PK_0ac1613009c8e7f41143a632032" PRIMARY KEY ("id"))`)
