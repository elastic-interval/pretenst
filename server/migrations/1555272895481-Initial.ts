...
export class Initial1555272895481 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "spot" ("id" SERIAL NOT NULL, "surface" "spot_surface_enum" NOT NULL DEFAULT 'unknown', "islandName" character varying, "hexalotId" character varying(32), "coordsX" integer NOT NULL, "coordsY" integer NOT NULL, CONSTRAINT "PK_f2a0a47e5ae78713daf83a5f7b0" PRIMARY KEY ("id"))`)
        ...
        await queryRunner.query(`CREATE TABLE "hexalot" ("id" character varying(32) NOT NULL, "nonce" integer NOT NULL, "genomeData" jsonb, "journey" jsonb, "islandName" character varying, "ownerId" integer, "parentId" character varying(32), "centerX" integer NOT NULL, "centerY" integer NOT NULL, CONSTRAINT "PK_0ac1613009c8e7f41143a632032" PRIMARY KEY ("id"))`)
