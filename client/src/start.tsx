    ...
    switch (versionFromUrl()) {
        case Version.Gotchi:
            ...
            const createTensegrity = (
                ...
                return new Tensegrity(gotchiLocation, 3, percentOrHundred(), gotchiValue, instance, toTenscript(code))
            }
        ...
        case Version.Bridge:
            ...
            const tensegrity = new Tensegrity(new Vector3(), 3, scale, numericFeature, bridgeInstance, tenscript)
