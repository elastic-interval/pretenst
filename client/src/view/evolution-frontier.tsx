...
function geometryRefreshed(frontier: IFrontier) {
    return (state: IEvolutionFrontierState, props: IEvolutionFrontierProps) => {
        if (state.geometry) {
...
export class EvolutionFrontier extends React.Component<IEvolutionFrontierProps, IEvolutionFrontierState> {
    ...
    public componentDidMount() {
        this.props.frontier.subscribe(frontier => this.setState(geometryRefreshed(frontier)));
    }
