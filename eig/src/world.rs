...
impl World {
    pub fn new(surface_character: SurfaceCharacter) -> World {
        World {
            ...
            color_pushes: true,
            color_pulls: true,
            gravity: default_fabric_feature(WorldFeature::Gravity),
            drag: default_fabric_feature(WorldFeature::Drag),
            pretenst_factor: default_fabric_feature(WorldFeature::PretenstFactor),
            iterations_per_frame: default_fabric_feature(WorldFeature::IterationsPerFrame),
            interval_countdown: default_fabric_feature(WorldFeature::IntervalCountdown),
            realizing_countdown: default_fabric_feature(WorldFeature::PretensingCountdown),
            slack_threshold: default_fabric_feature(WorldFeature::SlackThreshold),
            shaping_pretenst_factor: default_fabric_feature(WorldFeature::ShapingPretenstFactor),
            shaping_stiffness_factor: default_fabric_feature(WorldFeature::ShapingStiffnessFactor),
            shaping_drag: default_fabric_feature(WorldFeature::ShapingDrag),
            max_strain: default_fabric_feature(WorldFeature::MaxStrain),
            visual_strain: default_fabric_feature(WorldFeature::VisualStrain),
            nexus_push_length: default_fabric_feature(WorldFeature::NexusPushLength),
            column_push_length: default_fabric_feature(WorldFeature::ColumnPushLength),
            triangle_length: default_fabric_feature(WorldFeature::TriangleLength),
            ring_length: default_fabric_feature(WorldFeature::RingLength),
            cross_length: default_fabric_feature(WorldFeature::CrossLength),
            bow_mid_length: default_fabric_feature(WorldFeature::BowMidLength),
            bow_end_length: default_fabric_feature(WorldFeature::BowEndLength),
            ribbon_push_length: default_fabric_feature(WorldFeature::RibbonPushLength),
            ribbon_short_length: default_fabric_feature(WorldFeature::RibbonShortLength),
            ribbon_long_length: default_fabric_feature(WorldFeature::RibbonLongLength),
            ribbon_hanger_length: default_fabric_feature(WorldFeature::RibbonHangerLength),
            push_over_pull: default_fabric_feature(WorldFeature::PushOverPull),
            push_radius: default_fabric_feature(WorldFeature::PushRadius),
            pull_radius: default_fabric_feature(WorldFeature::PullRadius),
            joint_radius: default_fabric_feature(WorldFeature::JointRadius),
            max_stiffness: default_fabric_feature(WorldFeature::MaxStiffness),
            stiffness_factor: default_fabric_feature(WorldFeature::StiffnessFactor),
            antigravity: default_fabric_feature(WorldFeature::Antigravity),
        }
    }
    ...
    pub fn set_float_value(&mut self, feature: WorldFeature, value: f32) -> f32 {
        let value_pointer: &mut f32 = match feature {
            ...
            WorldFeature::SlackThreshold => &mut self.slack_threshold,
            ...
            WorldFeature::MaxStrain => &mut self.max_strain,
            ...
            WorldFeature::JointRadius => &mut self.joint_radius,
            WorldFeature::MaxStiffness => &mut self.max_stiffness,
