...
impl World {
    pub fn new(surface_character: SurfaceCharacter) -> World {
        World {
            ...
            slack_threshold: default_world_feature(WorldFeature::SlackThreshold),
            ...
            max_strain: default_world_feature(WorldFeature::MaxStrain),
            ...
            max_stiffness: default_world_feature(WorldFeature::MaxStiffness),
