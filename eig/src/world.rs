...
pub struct World {
    ...
    pub(crate) ribbon_short_pull_length: f32,
    pub(crate) ribbon_long_pull_length: f32,
...
impl World {
    pub fn new(surface_character: SurfaceCharacter) -> World {
        World {
            ...
            ribbon_short_pull_length: default_fabric_feature(FabricFeature::RibbonShortPullLength),
            ribbon_long_pull_length: default_fabric_feature(FabricFeature::RibbonLongPullLength),
    ...
    pub fn set_float_value(&mut self, feature: FabricFeature, value: f32) -> f32 {
        let value_pointer: &mut f32 = match feature {
            ...
            FabricFeature::RibbonShortPullLength => &mut self.ribbon_short_pull_length,
            FabricFeature::RibbonLongPullLength => &mut self.ribbon_long_pull_length,
