...
impl World {
    pub fn new(surface_character: SurfaceCharacter) -> World {
        World {
            ...
            realizing_countdown: default_fabric_feature(FabricFeature::PretensingCountdown),
            ...
            ribbon_push_length: default_fabric_feature(FabricFeature::RibbonPushLength),
            ribbon_short_length: default_fabric_feature(FabricFeature::RibbonShortLength),
            ribbon_long_length: default_fabric_feature(FabricFeature::RibbonLongLength),
            ribbon_hanger_length: default_fabric_feature(FabricFeature::RibbonHangerLength),
    ...
    pub fn set_float_value(&mut self, feature: FabricFeature, value: f32) -> f32 {
        let value_pointer: &mut f32 = match feature {
            ...
            FabricFeature::PretensingCountdown => &mut self.realizing_countdown,
            ...
            FabricFeature::RibbonPushLength => &mut self.ribbon_push_length,
            FabricFeature::RibbonShortLength => &mut self.ribbon_short_length,
            FabricFeature::RibbonLongLength => &mut self.ribbon_long_length,
            FabricFeature::RibbonHangerLength => &mut self.ribbon_hanger_length,
